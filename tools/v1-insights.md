# v1 INSIGHT POOL — 425 headlines harvested from v1

Draw from these. v1 is being replaced, so reuse is intended, not duplication.
Mark one used by adding it to titles.tsv. Do not use the same headline twice in v2.
